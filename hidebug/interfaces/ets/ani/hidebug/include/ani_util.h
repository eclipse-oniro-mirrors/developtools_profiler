...
public:
    ...
    static ani_status ToAniBigInt(ani_env *env, uint64_t uint64Val, ani_object &aniBigInt);
    ...
    static ani_status SetNamedPropertyBigInt(ani_env *env, ani_object object, const std::string& name, uint64_t value);
};
} // namespace HiviewDFX
} // namespace OHOS
