 ...
 *
 * @param interval If the cache of graphics memory is older than interval (unit: second), the latest
 ...
 * @returns { HiDebug_ErrorCode } Returns the error code of the stack sampling.
 * @return Result code.
