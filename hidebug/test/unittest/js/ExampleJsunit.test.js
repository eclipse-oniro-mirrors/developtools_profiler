...
describe("HidebugJsTest", function () {
     ...
     */
        ...
        /**
         * @tc.name:
         * @tc.desc: getAppNativeMemInfoAsync的正常测试, getVss()/getPss()/getSharedDirty()/getPrivateDirty()的更新版本
         * @tc.type: FUNC
         * @tc.require: issueI5VY8L
         */
        it('HidebugJsTest_getAppNativeMemInfoAsync', 0, async function () {
            console.info("---------------------------HidebugJsTest_getAppNativeMemInfoAsync----------------------------------");
            try {
        ...
        /**
         * @tc.name:
         * @tc.desc: getAppNativeMemInfoWithCache的异常参数测试, getVss()/getPss()/getSharedDirty()/getPrivateDirty()的更新版本
         * @tc.type: FUNC
         * @tc.require: issueI5VY8L
         */
        it('HidebugJsTest_getAppNativeMemInfoWithCache1', 0, async function () {
            console.info("---------------------------HidebugJsTest_getAppNativeMemInfoWithCache1----------------------------------");
            try {
                hidebug.getAppNativeMemInfoWithCache("TEST");
            } catch (error) {
                console.info(error.code);
                console.info(error.message);
                expect(error.code === "401").assertTrue();
         ...
         * @tc.require: issueI5VY8L
         */
        it('HidebugJsTest_getAppNativeMemInfoWithCache2', 0, async function () {
            console.info("---------------------------HidebugJsTest_getAppNativeMemInfoWithCache2----------------------------------");
            try {
        ...
        function assertNativeMemInfoEqual(nativeMemInfoA, nativeMemInfoB) {
        ...
        /**
         * @tc.name:
         * @tc.desc: getAppNativeMemInfoWithCache的正常测试, getVss()/getPss()/getSharedDirty()/getPrivateDirty()的更新版本
         * @tc.type: FUNC
         * @tc.require: issueI5VY8L
         */
        it('HidebugJsTest_getAppNativeMemInfoWithCache3', 0, async function () {
            console.info("---------------------------HidebugJsTest_getAppNativeMemInfoWithCache3----------------------------------");
            try {
                ...
                let nativeMemInfo3 = hidebug.getAppNativeMemInfoWithCache();
    ...
    /**
     * @tc.name: HidebugJsTest_036
     * @tc.desc: testDumpJsRawHeapData1
     * @tc.type: FUNC
     */
    it('HidebugJsTest_036', 0, async function () {
        console.info("---------------------------HidebugJsTest_036----------------------------------");
        hidebug.dumpJsRawHeapData("TEST").then((path) => {
            expect(false).assertTrue();
        }).catch(error => {
            expect(error.code === "401").assertTrue();
        });
    ...
    /**
     * @tc.name: HidebugJsTest_037
     * @tc.desc: setJsRawHeapTrimLevel
     * @tc.type: FUNC
     */
    it('HidebugJsTest_037', 0, function () {
        console.info("---------------------------HidebugJsTest_037----------------------------------");
        try {
            hidebug.setJsRawHeapTrimLevel(2);
            expect().assertFail();
        } catch (error) {
            console.info(error.code);
            expect(error.code === "401").assertTrue();
    ...
    /**
     * @tc.name: HidebugJsTest_038
     * @tc.desc: setJsRawHeapTrimLevel
     * @tc.type: FUNC
     */
    it('HidebugJsTest_038', 0, function () {
        console.info("---------------------------HidebugJsTest_038----------------------------------");
        try {
            hidebug.setJsRawHeapTrimLevel("abc");
            expect().assertFail();
        } catch (error) {
            console.info(error.code);
            expect(error.code === "401").assertTrue();
    ...
    /**
     * @tc.name: HidebugJsTest_039
     * @tc.desc: setJsRawHeapTrimLevel
     * @tc.type: FUNC
     */
    it('HidebugJsTest_039', 0, function () {
        console.info("---------------------------HidebugJsTest_039----------------------------------");
        try {
            hidebug.setJsRawHeapTrimLevel(1);
            expect(true).assertTrue();
        } catch (error) {
            console.info(error.code);
            expect(error.code === "401").assertTrue();
    ...
    /**
     * @tc.name: HidebugJsTest_040
     * @tc.desc: setJsRawHeapTrimLevel
     * @tc.type: FUNC
     */
    it('HidebugJsTest_040', 0, function () {
        console.info("---------------------------HidebugJsTest_040----------------------------------");
        try {
            hidebug.setJsRawHeapTrimLevel(1, 2);
            expect().assertFail();
        } catch (error) {
            console.info(error.code);
            expect(error.code === "401").assertTrue();
    ...
    /**
     * @tc.name: HidebugJsTest_041
     * @tc.desc: setJsRawHeapTrimLevel
     * @tc.type: FUNC
     */
    it('HidebugJsTest_041', 0, function () {
        console.info("---------------------------HidebugJsTest_041----------------------------------");
        try {
            hidebug.setJsRawHeapTrimLevel(hidebug.JsRawHeapTrimLevel.TRIM_LEVEL_1);
            expect(true).assertTrue();
        } catch (error) {
            console.info(error.code);
    ...
    /**
     * @tc.name: HidebugJsTest_042
     * @tc.desc: setJsRawHeapTrimLevel
     * @tc.type: FUNC
     */
    it('HidebugJsTest_042', 0, function () {
        console.info("---------------------------HidebugJsTest_042----------------------------------");
        try {
    ...
    /**
     * @tc.name: HidebugJsTest_043
     * @tc.desc: getAppVMObjectUsedSize
     * @tc.type: FUNC
     */
    it('HidebugJsTest_043', 0, function () {
        console.info("---------------------------HidebugJsTest_043----------------------------------");
        try {
            let ret = hidebug.getAppVMObjectUsedSize();
            console.info(`HidebugJsTest_043 getAppVMObjectUsedSize ret：: ${ret}`);
    ...
    /**
     * @tc.name: HidebugJsTest_044
     * @tc.desc: getGraphicsMemorySummary
     * @tc.type: FUNC
     */
    it('HidebugJsTest_044', 0, async function () {
        console.info("---------------------------HidebugJsTest_044----------------------------------");
        try {
            let ret = await hidebug.getGraphicsMemorySummary();
            expect(ret.gl >= 0 && ret.graph >= 0).assertTrue();
        } catch (error) {
            console.error(error.code);
            console.error(error.message);
            expect().assertFail();
    ...
    /**
     * @tc.name: HidebugJsTest_045
     * @tc.desc: setProcDumpInSharedOOM
     * @tc.type: FUNC
     */
    it('HidebugJsTest_045', 0, async function () {
        console.info("---------------------------HidebugJsTest_045----------------------------------");
        try {
    ...
    /**
     * @tc.name: HidebugJsTest_046
     * @tc.desc: setProcDumpInSharedOOM
     * @tc.type: FUNC
     */
    it('HidebugJsTest_046', 0, async function () {
        console.info("---------------------------HidebugJsTest_046----------------------------------");
        try {
    ...
    /**
     * @tc.name: HidebugJsTest_047
     * @tc.desc: setProcDumpInSharedOOM
     * @tc.type: FUNC
     */
    it('HidebugJsTest_047', 0, async function () {
        console.info("---------------------------HidebugJsTest_047----------------------------------");
        try {
    ...
    /**
     * @tc.name: HidebugJsTest_048
     * @tc.desc: setProcDumpInSharedOOM
     * @tc.type: FUNC
     */
    it('HidebugJsTest_048', 0, async function () {
        console.info("---------------------------HidebugJsTest_048----------------------------------");
        try {
            hidebug.setProcDumpInSharedOOM(1);
            expect(true).assertFalse();
        } catch (error) {
            console.error(error.code);
            console.error(error.message);
