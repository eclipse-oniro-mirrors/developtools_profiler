...
using SubEventParser = SubEventParser<FtraceEvent>;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SubEventParserTest, IsSupportName, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SubEventParserTest, SetupEvent, TestSize.Level0)
{
    EventFormat format;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SubEventParserTest, IsSupportId, TestSize.Level0)
{
    EventFormat format;
    FtraceParser ftraceParser;
    format.eventType = "sched";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SubEventParserTest, ParseEvent, TestSize.Level0)
{
    EventFormat format;
    FtraceParser ftraceParser;
    format.eventType = "sched";
    ...
    FtraceEvent event = {};
    auto* ctx = SubEventParser::GetInstance().GetParseEventCtx(format.eventId);
