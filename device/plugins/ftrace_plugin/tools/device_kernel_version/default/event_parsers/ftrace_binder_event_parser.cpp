...
template <typename T> void binder_alloc_lru_end_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_alloc_lru_end,
...
template <typename T> void binder_alloc_lru_start_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_alloc_lru_start,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_alloc_page_end_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_alloc_page_end,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_alloc_page_start_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_alloc_page_start,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_command_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_cmd(FtraceFieldParser::ParseIntField<uint32_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_command,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_command,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_command_format();
        if (msg != nullptr) {
            binder_command_func(msg, data, size, format);
...
template <typename T> void binder_free_lru_end_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_free_lru_end,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_free_lru_start_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_free_lru_start,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_ioctl_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_cmd(FtraceFieldParser::ParseIntField<uint32_t>(format.fields, i++, data, size));
    msg->set_arg(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_ioctl,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_ioctl,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_ioctl_format();
        if (msg != nullptr) {
            binder_ioctl_func(msg, data, size, format);
...
template <typename T> void binder_ioctl_done_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_ret(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_ioctl_done,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_lock_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_tag(FtraceFieldParser::ParseStrField(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_lock,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_lock,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_lock_format();
        if (msg != nullptr) {
            binder_lock_func(msg, data, size, format);
...
template <typename T> void binder_locked_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_tag(FtraceFieldParser::ParseStrField(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_locked,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_locked,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_locked_format();
        if (msg != nullptr) {
            binder_locked_func(msg, data, size, format);
...
template <typename T> void binder_read_done_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_ret(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_read_done,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_return_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_cmd(FtraceFieldParser::ParseIntField<uint32_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_return,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_return,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_return_format();
        if (msg != nullptr) {
            binder_return_func(msg, data, size, format);
...
template <typename T> void binder_transaction_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    ...
    int8_t reply = FtraceFieldParser::ParseIntField<int8_t>(format.fields, i++, data, size);
    msg->set_reply(static_cast<int32_t>(reply));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_alloc_buf,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_buffer_release,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_failed_buffer_release,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_transaction_failed_buffer_release,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_transaction_failed_buffer_release_format();
        if (msg != nullptr) {
            binder_transaction_failed_buffer_release_func(msg, data, size, format);
...
template <typename T> void binder_transaction_fd_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_debug_id(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_fd,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_transaction_fd_format();
        if (msg != nullptr) {
            binder_transaction_fd_func(msg, data, size, format);
        }
    });
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_transaction_fd,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_transaction_fd_format();
        if (msg != nullptr) {
            binder_transaction_fd_func(msg, data, size, format);
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_node_to_ref,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_received,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_ref_to_node,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_transaction_ref_to_ref,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_unlock_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_tag(FtraceFieldParser::ParseStrField(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_unlock,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(binder_unlock,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_binder_unlock_format();
        if (msg != nullptr) {
            binder_unlock_func(msg, data, size, format);
...
template <typename T> void binder_unmap_kernel_end_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_unmap_kernel_end,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_unmap_kernel_start,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_unmap_user_end_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_unmap_user_end,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_unmap_user_start_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
    msg->set_page_index(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_unmap_user_start,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_update_page_range_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_proc(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_update_page_range,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_wait_for_work_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_wait_for_work,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void binder_write_done_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_ret(FtraceFieldParser::ParseIntField<int32_t>(format.fields, i++, data, size));
}
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(binder_write_done,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
