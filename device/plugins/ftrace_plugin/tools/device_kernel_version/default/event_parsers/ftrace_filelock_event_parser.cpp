...
template <typename T> void break_lease_block_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(break_lease_block,
...
template <typename T> void break_lease_noblock_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_fl(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
    msg->set_i_ino(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(break_lease_noblock,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void break_lease_unblock_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_fl(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
    msg->set_i_ino(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(break_lease_unblock,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void generic_add_lease_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_i_ino(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(generic_add_lease,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void generic_delete_lease_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_fl(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
    msg->set_i_ino(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(generic_delete_lease,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
...
template <typename T> void time_out_leases_func(T& msg, uint8_t data[], size_t size, const EventFormat& format)
{
    int i = 0;
    msg->set_fl(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
    msg->set_i_ino(FtraceFieldParser::ParseIntField<uint64_t>(format.fields, i++, data, size));
...
REGISTER_FTRACE_EVENT_PARSE_FUNCTION(time_out_leases,
    [](FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_time_out_leases_format();
        time_out_leases_func(msg, data, size, format);
    });
REGISTER_FTRACE_EVENT_PARSE_ENCODER_FUNCTION(time_out_leases,
    [](ProtoEncoder::FtraceEvent& ftraceEvent, uint8_t data[], size_t size, const EventFormat& format) {
        auto msg = ftraceEvent.mutable_time_out_leases_format();
        time_out_leases_func(msg, data, size, format);
    });
