...
inline void VirtualRuntime::FillSymbolNameId(CallFrame& callFrame, DfxSymbol& symbol)
{
...
inline void VirtualRuntime::FillFileSet(CallFrame& callFrame, const DfxSymbol& symbol)
{
