...
class CommandPoller : public IPluginServiceClient {
public:
    ...
    virtual void PushResult(const ProfilerPluginState& pluginState, uint32_t pluginId);
...
private:
    ...
    std::atomic<uint32_t> requestIdAutoIncrease_;
