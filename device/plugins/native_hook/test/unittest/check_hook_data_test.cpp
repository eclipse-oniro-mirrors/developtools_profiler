    ...
    void StartDaemonProcessArgs()
    {
        ...
        if (processNum == 0) {
            ...
            if (sampleInterval_ > 0) {
                command_.push_back(const_cast<char*>("-i"));
