...
#ifndef NETWORK_PROFILER_WRITER_H
#define NETWORK_PROFILER_WRITER_H
...
class NetworkProfilerWriter : public Writer {
public:
    NetworkProfilerWriter(std::string name,
                 uint32_t size,
                 int smbFd,
                 int eventFd,
                 bool block);
    ~NetworkProfilerWriter();
...
#endif // NETWORK_PROFILER_WRITER_H