...
import threading
sys.path.append("..")
from tools.utils import SMALL_FILE_EXPECTED_SIZE
...
def task3():
    subprocess.check_output(f'hdc shell "hiprofiler_cmd -c /data/local/tmp/config_hisysevent3.txt -o /data/local/tmp/test_hisysevent3.htrace -t 30 -s -k"')
