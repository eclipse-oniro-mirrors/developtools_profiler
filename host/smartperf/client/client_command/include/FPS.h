...
public:
    ...
    void SetHapFlag();
    void GetTouchEventNum();
    void GetDistr();
    void GetDistrTimes(std::string &line, long long &tamps);
...
private:
    ...
    int touchEvent = 0;
    long long diStr_ = 0;
    long long totalDistr = 0;
    int distrNum = 0;
    long long avgDistr = 0;
    ...
    std::string winId_ = "";
    std::mutex touchEventLock_;
    std::mutex distrLock_;
};
}
}
#endif
